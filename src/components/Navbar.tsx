                  ...
                  <MaxWidthWrapper>
                        <nav className='w-full flex justify-between py-6 mt-4 backdrop-blur-sm'>
                              <ul className='flex gap-18 text-xl text-white'>
                                    <li><CustomLink hoverVariant="hoverCenter" href='/product' text='Man' /></li>
                                    <li><CustomLink hoverVariant="hoverCenter" href='/product' text='Woman' /></li>
                  ...
                  <MaxWidthWrapper>
                        <nav className='flex justify-between py-2 px-8 bg-slate-100 rounded-2xl'>
                              <ul className='flex items-center gap-12 py-4 font-semibold text-primary-700'>
                                    ...
                                    <List><CustomLink hoverVariant="hoverCenter" colorUnderline="primaryDark2" text='Man' href='/pruduct' /></List>
                                    <List><CustomLink hoverVariant="hoverCenter" colorUnderline="primaryDark2" text='Woman' href='/pruduct' /></List>
                                    <List><CustomLink hoverVariant="hoverCenter" colorUnderline="primaryDark2" text='Best Seller' href='/best-seller' /></List>
                              </ul>
                              <ul className='flex items-center gap-12 py-4 font-semibold text-primary-700'>
                                    <List>
                                          <CustomLink href='/cart'>
                                                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth="2" stroke="currentColor" className="size-8 hover:">
