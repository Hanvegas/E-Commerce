        ...
        <div className='flex justify-between items-center w-full z-30'>
          ...
          <div className='w-auto mt-80'>
            ...
            <div className='flex mt-10 gap-6'>
              ...
              <Button variant={"outline"} size={"lg"}>Categories</Button>
            </div>
          </div>

          {/* Right Text */}
          <div className='flex flex-col items-end w-auto mb-80 text-right text-white'>
            <span
            ...
            <span
              className='block italic mt-6 text-2xl'>"Fashion that speaks before you do"
            </span>
          </div>
